...
REQUIRED_FILES = [
    ...
    "scripts/linux-product/l6_upgrade_quiesced_registration_shell_bindings.py",
    "scripts/linux-product/l6_upgrade_quiesced_registration_shell.applescript",
    "scripts/linux-product/l6_upgrade_quiesced_clone_front_door.py",
    "scripts/linux-product/l6_upgrade_quiesced_clone_bindings.py",
    ...
    "scripts/linux-product/test_l6_utm_clone_once.py",
    "scripts/linux-product/test_l6_upgrade_quiesced_clone_front_door.py",
    "scripts/linux-product/test_l6_upgrade_quiesced_registration_shell.py",
    ...
    "scripts/linux-product/test_l6_utm_launch_transport_v2.py",
    "scripts/linux-product/test_l6_utm_launch_prepared_bindings.py",
    "scripts/linux-product/test_l6_utm_guest_network_ready.py",
    "scripts/linux-product/test_l6_utm_canonical_input_transfer.py",
    "scripts/linux-product/test_l6_utm_canonical_input_resolution.py",
    "scripts/linux-product/test_l6_v4_canonical_input_resolution_probe.py",
    "scripts/linux-product/test_l6_utm_canonical_input_preflight.py",
    "scripts/linux-product/test_l6_v4_canonical_input_preflight_probe.py",
    "scripts/linux-product/test_l6_utm_install_artifacts_staged_checkpoint.py",
    "scripts/linux-product/test_l6_v4_install_artifacts_staged_checkpoint_driver.py",
    "scripts/linux-product/test_l6_utm_install_artifacts_staged_resume.py",
    "scripts/linux-product/test_l6_v4_install_artifacts_staged_resume_driver.py",
    "scripts/linux-product/test_l6_v4_canonical_input_bundle.py",
