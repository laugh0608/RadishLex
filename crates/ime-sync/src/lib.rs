...
pub use remote::{
    ...
    RemoteRecoveredDeviceActivation, RemoteRecoveredDeviceResult, RemoteRecoveryRecordRevocation,
    RemoteRecoveryRecordRevocationResult, RemoteRecoveryRecordRotation,
