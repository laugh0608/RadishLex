...
pub use signing::{
    ...
    SignedRecoveryRecordManifest, SignedRecoveryRecordRevocation, SignedSyncObjectManifest,
    TestMemoryDeviceKeyStore, UnavailableDeviceKeyStore, DEVICE_KEY_STORE_ANDROID_KEYSTORE_V1,
    ...
    RECOVERY_RECORD_REVOCATION_RECORD_TYPE, SIGNATURE_ALGORITHM_ECDSA_P256_SHA256_V1,
