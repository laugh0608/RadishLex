...
- host contract catalog 中的合成 ABI status / input case / required evidence，以及 host gate migration readiness 阻塞项，能被测试侧 fake native binding 重放并保持非敏感摘要。
