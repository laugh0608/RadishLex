...
26. 已补 `docs/adr/0002-recovery-code-kdf.md`，固定恢复码 KDF 算法、参数、格式、恢复记录字段和验证口径；在生产恢复码实现、签名 / 设备密钥存储和真实 payload / userdb 写回接线稳定前，不进入远端同步或管理 UI 同步主线。
