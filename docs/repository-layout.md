...
- `platforms/android-ime/keystore-bridge/`：Android Keystore bridge 仓库内 Kotlin source，固定 `android-keystore-v1` 的 `AndroidKeyStore` / `Ed25519` 创建、加载、公钥读取、签名、删除和错误码映射；当前不包含 Gradle 工程、JNI glue、真实设备 smoke 或完整 Android IME。
