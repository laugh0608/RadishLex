...
优先审阅 WAL 源库准备与新 operation 的持久化/恢复合同，批准后再做实现和隔离资格；新载体与升级真正完成后，才继续客户端身份和 composition 隐私实测。今日恢复只回到 source 39 基线，不直接重试 40。顺序、验证矩阵与进入实机前的条件见[明日事项](../devlogs/2026-W37.md#2026-09-10明日事项)；书面计划不授予新系统动作，今晚停止推进。
