...
- 同步页和设置页 gate preview 展示同一组 readiness 聚合摘要、只读 action intent 进入计划、action command preview 和 `readiness_bridge_source` 来源标签，不提供操作按钮。
