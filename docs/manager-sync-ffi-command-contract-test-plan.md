...
- `sync_ffi_rust_host_migration_review_fixtures.dart` 中 native export approval、Dart binding migration、ManagerBridge migration、host test file approval 和 real sync execution gate fixture
