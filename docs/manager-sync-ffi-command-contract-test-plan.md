...
| L2 | Rust host contract test 计划 | 已补评审材料、source-level checklist、test design fixture 与 C ABI contract review matrix | 在新增 symbol 前先明确测试文件、输入样本、错误码、释放责任、既有 FFI 源码模式映射和 forbidden material 断言。 |
