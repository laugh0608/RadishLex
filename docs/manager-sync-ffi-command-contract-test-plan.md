...
| L3 | Dart FFI binding contract test 计划 | 本文固定 | 在 Dart native binding 扩展前先明确 capability missing、copy / free、unknown status 和错误映射测试。 |
...
1. 先用 fake native binding 验证 mapper、copy / free 调用记录和错误分类。
