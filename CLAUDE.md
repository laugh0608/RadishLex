...
- production 源码、L6 format v1、acceptance controller、release-pair 与 maintenance-only refresh v1 合同已闭合。六类 operation 均有独立证据。首个 `install_prepared` checkpoint 暴露的 Debian `01777` startup 缺陷已由 `a6622d4` 修复，target `d75818f` 的 pair record `c74fac12…9849` 已冻结。两台harness失败retry已归档/清理。第三台clean clone `3EC83EB9…593B9`现为唯一started VM；同一断网boot内canonical input与fresh-absent preflight已通过，manifest `0b703d10…5027`证明operation ID/state/checkpoint/guard均absent，其余十七台stopped。v1 package不含RadishLex maintainer scripts。
