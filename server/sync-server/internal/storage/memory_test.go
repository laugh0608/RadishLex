...
func TestMemoryStoreAcceptsEncryptedObjectAndReturnsPayloadByMetadata(t *testing.T) {
...
func TestMemoryStoreDetectsObjectVersionConflictsAndIdempotentRetry(t *testing.T) {
	ctx := context.Background()
	store := newReadyStore(t)
...
func TestMemoryStoreBlocksRevokedDevicesAndOldKeyEpochWrites(t *testing.T) {
	ctx := context.Background()
	store := newReadyStore(t)
...
func TestJoinAuthorizationActivatesDeviceAndStoresWrappingMetadata(t *testing.T) {
	ctx := context.Background()
	store := newReadyStore(t)
	saveJoinAndAuthorize(t, store, "domain-a", "join-b", "device-b", 20)
...
func TestRecoveryRecordStoresOnlyWrappedMaterialMetadata(t *testing.T) {
	ctx := context.Background()
	store := newReadyStore(t)
...
func newReadyStore(t *testing.T) *MemoryStore {
	t.Helper()
...
func saveJoinAndAuthorize(t *testing.T, store *MemoryStore, domainID string, joinID string, deviceID string, atMs int64) {
	t.Helper()
	ctx := context.Background()
	request := JoinRequest{
		DomainID:                domainID,
...
func putExpectError(store *MemoryStore, upload ObjectVersionUpload) error {
